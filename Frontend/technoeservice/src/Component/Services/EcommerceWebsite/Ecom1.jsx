...
import contentImage from "../../../image/617-6175517_shop-smart-e-commerce-illustration-png-transparent-png.png"; // Update with actual image path

const EcommerceDevCom1 = () => {
  return (
    <div className="EcommerceDevCom1-main-container">
